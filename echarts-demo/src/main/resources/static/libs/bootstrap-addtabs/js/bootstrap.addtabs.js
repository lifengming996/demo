...
(function($) {
    var settings = {
        ...
        iframeHeight:(document.body.scrollHeight+268)+"px",
        //iframeHeight:Math.min(document.documentElement.scrollHeight,document.body.scrollHeight), //固定TAB中IFRAME高度,根据需要自己修改
        //iframeHeight:$(window.parent.document).find("iframe[id='iframeclass']").height($($("#iframeclass").parent().attr('id')).height()),
        target: '.nav-tabs',
